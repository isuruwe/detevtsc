...
namespace vtscsharp
{
    ...
    public class getdate : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
           ...
           // sqlQuery = " SELECT TOP 1 locdata FROM vtsdata where devid='" + devid + "'  ORDER BY vtsid DESC ";
             sqlQuery = " SELECT  locdata FROM vtsdata where devid='" + devid + "' and  createddate between   '" + dt1 + "' and '" + dt2 + "'  ORDER BY vtsid DESC ";
